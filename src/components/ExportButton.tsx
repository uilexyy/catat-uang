  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        disabled={exporting}
        className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-white border border-stone-200 hover:border-stone-300 text-stone-600 hover:text-stone-800 text-xs sm:text-sm font-medium rounded-xl shadow-sm hover:shadow-md active:scale-[0.97] transition-all duration-200 disabled:opacity-50"
      >
        {exporting ? (
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl border border-stone-200 shadow-xl z-50 py-1 animate-fade-in">
          <button
            type="button"
          ...
          >
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-400">Sesuai filter saat ini</p>
            </div>
          </button>
          <button
            type="button"
          ...
          >
            ...
            <div>
              ...
              <p className="text-[11px] text-stone-400">Semua transaksi tanpa filter</p>
            </div>
          </button>
        </div>
      )}
