...
export default function DebtSummaryCards({ totalDebt, totalPaid }: DebtSummaryCardsProps) {
  return (
    <div className="grid grid-cols-2 gap-3">
      <div className="bg-white rounded-2xl border border-stone-200 p-4 sm:p-5 animate-fade-in-up">
      ...
      <div className="bg-white rounded-2xl border border-stone-200 p-4 sm:p-5 animate-fade-in-up [animation-delay:0.05s]">
        <div className="flex items-center gap-2.5 mb-3">
