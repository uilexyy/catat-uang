...
export default function Error({ reset }: { reset: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
      ...
      <h2 className="text-base font-bold text-stone-800 mb-1">Gagal Memuat Transaksi</h2>
      <p className="text-sm text-stone-400 mb-5">Transaksi tidak ditemukan atau terjadi kesalahan.</p>
      <button
        onClick={reset}
