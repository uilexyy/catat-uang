    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-stone-800 dark:text-stone-200">Buat Akun</h1>
          <p className="text-sm text-stone-400 dark:text-stone-500 mt-1">Daftar untuk mulai mencatat keuangan</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white dark:bg-stone-900/80 backdrop-blur-xl rounded-2xl border border-stone-200/80 dark:border-stone-800 p-6 shadow-sm space-y-4">
          ...
          <div>
            <label className="block text-xs font-semibold text-stone-400 dark:text-stone-500 uppercase tracking-wider mb-1.5">Nama</label>
            <input
              type="text"
              value={name}
